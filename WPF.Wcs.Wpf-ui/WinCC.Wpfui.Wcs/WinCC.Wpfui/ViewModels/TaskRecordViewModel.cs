...
public partial class TaskRecordViewModel(ISnackbarService snackbarService, ILogger<ProgramViewModel> logger, IBllLocation bllLocation, IContentDialogService contentDialogService) : ViewModel
{
    [ObservableProperty]
