...
public partial class MainWindowViewModel : ViewModel
{
    ...
    private void InitializeViewModel()
    {
        ...
        [
            ...
            {
                Content = "任务",
                Icon = new SymbolIcon { Symbol = SymbolRegular.BranchCompare24 },   Width = 105,Height=70,HorizontalAlignment = HorizontalAlignment.Center,
                TargetPageType = typeof(Views.Pages.TaskRecordPage),
                Margin = new Thickness(0 ,10 ,0 ,0)
            },
            new NavigationViewItem()
            {
                Content = "库位",
                Icon = new SymbolIcon { Symbol = SymbolRegular.Grid24 },   Width = 105,Height=70,HorizontalAlignment = HorizontalAlignment.Center,
                TargetPageType = typeof(Views.Pages.ProgramPage),    Margin = new Thickness(0 ,10 ,0 ,0)
            },
              new NavigationViewItem()
            {
                Content = "条码",
                Icon = new SymbolIcon { Symbol = SymbolRegular.TextNumberFormat24 },   Width = 105,Height=70,HorizontalAlignment = HorizontalAlignment.Center,
