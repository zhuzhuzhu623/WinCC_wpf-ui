...
namespace FileController.DapperDal
{
    public class DapperHelper : IDapper
    {
        ...
        public DapperHelper() 
        {
            ConnectionString = $"Data Source=WIN-1OA85801VP6\\WinCC;Initial Catalog=WinCC_Wcs;Persist Security Info=True;User ID=sa;Password=123456";
            SQLDialect = (SimpleCRUD.Dialect)SimpleCRUD.Dialect.SQLServer;
