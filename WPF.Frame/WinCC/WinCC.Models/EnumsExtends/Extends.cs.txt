...
namespace WinCC.Model.EnumsExtends
{
    public static class Extends
    {
        ...
        public static string ToEnumString<T>(this short obj) where T : struct
        {
            try
            {
                return Enum.Parse(typeof(T), obj.ToString(), true).ToString();
            }
            catch (Exception)
            {
                return "";
